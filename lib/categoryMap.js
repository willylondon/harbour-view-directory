...
const EDUCATION_KEYWORDS = ['teacher', 'tutor', 'tutoring', 'school', 'class', 'lessons', 'education', 'academy', 'learning', 'students', 'csec', 'cape', 'homework', 'reading', 'maths', 'math', 'english', 'basic school', 'prep school', 'college', 'learning centre', 'learning center'];
