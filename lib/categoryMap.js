...
const CATEGORY_RULES = [
  // Cooking Gas — MUST be first: 'cook' in description matches Food rule otherwise
  {
    ...
    keywords: ['cooking gas', 'gas cylinder', 'propane', 'tuna gas', 'vespak', 'igl cylinder',
               'igl gas', 'vp gas', 'gas supplier', 'cooking gas supplier', 'gas delivery'],
  },
  ...
  // Food & Beverage
  {
    ...
    keywords: ['food', 'restaurant', 'deli', 'catering', 'baker', 'baking', 'cake', 'pastry',
               ...
               'jerk', 'snack', 'bbq', 'bar', 'cafe', 'liquor', 'wholesale liquor'],
  },
