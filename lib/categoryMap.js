...
const GROCERY_KEYWORDS = ['supermarket', 'grocery', 'groceries', 'mini mart', 'minimart', 'convenience', 'wholesale', 'market', 'corner shop', 'corner-store', 'produce'];
...
const TECH_KEYWORDS = ['phone repair', 'computer', 'laptop', 'tablet', 'electronics', 'it', 'network', 'printer', 'camera', 'cctv', 'software', 'hardware'];
const TECH_CONTEXT = ['phone', 'computer', 'laptop', 'tablet', 'electronics', 'it', 'network', 'printer', 'camera', 'cctv', 'software', 'hardware'];
const HOME_SERVICE_KEYWORDS = ['plumber', 'plumbing', 'electrician', 'electrical', 'locksmith', 'carpenter', 'gardener', 'landscaper', 'painter', 'tiler', 'welder', 'appliance', 'fridge repair', 'washing machine', 'stove repair', 'oven', 'air conditi', 'ac technician', 'pest control', 'roofing', 'solar', 'water heater', 'water truck', 'water tank', 'upholsterer', 'handyman', 'general repair', 'odd jobs'];
