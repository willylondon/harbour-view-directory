...
export const PUBLIC_VENDOR_COLUMNS = 'id, business_name, category, description, slug, address, whatsapp, phone, images, is_featured, is_top_ad, created_at, updated_at, locality_status, public_visibility, data_quality_status';
