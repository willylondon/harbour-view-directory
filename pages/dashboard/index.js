                    ...
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <div className="flex gap-3">
                            <Link href="/dashboard/events">
                                <button className="bg-brand-yellow text-gray-900 font-bold px-4 py-2 rounded hover:bg-yellow-400 transition shadow-sm">
                                    Manage Events
                                </button>
                            </Link>
                            <Link href="/dashboard/help">
                                <button className="bg-white text-gray-700 font-bold px-4 py-2 rounded border border-gray-200 hover:bg-gray-50 transition shadow-sm">
                                    Help
                                </button>
                            </Link>
                            <Link href="/pricing">
                                <button className="bg-white text-brand-blue font-bold px-4 py-2 rounded border border-brand-blue/30 hover:bg-blue-50 transition shadow-sm">
                                    View Pricing
                                </button>
                            </Link>
                            ...
                            {vendors.map(vendor => (
                                <div key={vendor.id} className="p-4 flex justify-between items-center hover:bg-gray-50">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <Link href={`/dashboard/vendor/${vendor.id}`} className="text-gray-600 font-semibold text-sm hover:underline px-3 py-1">Edit</Link>
                                    </div>
                                </div>
                            ))}
                        </div>
