...
const CATEGORY_MAP = {
    ...
    'Education': ['school', 'tutor', 'teacher', 'academy', 'class', 'learn', 'education', 'cmu', 'college', 'students', 'csec', 'cape', 'homework', 'reading', 'maths', 'math', 'english'],
    ...
    'Health & Medical': ['clinic', 'pharmacy', 'dental', 'health', 'medical', 'hospital', 'optician', 'therapy', 'physician', 'dentist', 'nurse', 'patient', 'surgery', 'lab', 'doctor office'],
